                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Catalog name</th><th>Product Slug</th><th>Product Name</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($products as $item)
                                    <tr>
                                        <td>{{ $item->id }}</td>
                                        <td>{{ $item->cata->catalog_name }}</td><td>{{ $item->product_slug }}</td><td>{{ $item->product_name }}</td>
                                        <td>
