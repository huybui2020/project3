                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Catalog Id </th><td> {{ $product->catalog_id }} </td></tr><tr><th> Product Slug </th><td> {{ $product->product_slug }} </td></tr><tr><th> Product Name </th><td> {{ $product->product_name }} </td></tr>
                                </tbody>
                            </table>
                        </div>
